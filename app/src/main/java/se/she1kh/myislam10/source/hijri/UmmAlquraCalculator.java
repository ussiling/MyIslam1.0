 ...
 * Description:
 * ------------
 *  Copyright (c) 2004, 2013 Arabeyes, Fayez Alhargan, Fikrul Arif
 *  
 *    The original program authored by Fayez Alhargan is written in C
 ...
 ************************************************************************/
package se.she1kh.myislam10.source.prayer.hijri;

/**
 * Calculator for converting between Umm Al-Qura and Gregorian calendar.
 * <p>
...
class UmmAlquraCalculator {
	...
	private static final short[] gmonth={31,31,28,31,30,31,30,31,31,30,31,30,31,31};

	/* makes it circular m[0]=m[12] & m[13]=m[1]  */
//	private static final short[] smonth={31,30,30,30,30,30,29,31,31,31,31,31,31,30};
	...
	/****************************************************************************/
	private static int Hsub2G(HijriCalculator.sDate mydate, int mh, int yh)
	{
	   int flag;
	   int JD;
	   double GJD;
...
//	}
	...
	/*       and returns flag found:1 not found:0                               */
	/****************************************************************************/
	static int G2H(HijriCalculator.sDate mydate, int dg, int mg, int yg)
	{
	   int  yh2, mh2;
	   int  df;
	   int flag = 1;
	   int J;
	   double GJD, HJD;
	   HijriCalculator.sDate tmpdate = new HijriCalculator.sDate();
	   HijriCalculator.sDate tmpdate2 = new HijriCalculator.sDate();
	...
	/****************************************************************************/
	static int H2G(HijriCalculator.sDate mydate, int dh, int mh, int yh)
	{
	   int found, yh1, mh1;
	   HijriCalculator.sDate tmpdate = new HijriCalculator.sDate();
	...
	/****************************************************************************/
	private static double JDToGCalendar(double JD, HijriCalculator.sDate mydate)
	{
	   double A, B, F;
	   int alpha, C, E;
	   int D, Z;
	   ...
	   D = (int) (365.25 * C);
	   E = (int)(((B - D) / 30.6001));
	   mydate.day =(int) (B - D - Math.floor(30.6001 * E) + F);
	   if (E < 14)
	      mydate.month = E - 1;
	   else
	      mydate.month = E - 13;
	...
	/****************************************************************************/
	private static void GDateAjust(HijriCalculator.sDate mydate)
	{
	   int dys;
...
//	}
	...
	/****************************************************************************/
	private static void JDToHCalendar(double JD, HijriCalculator.sDate mydate)
	{
